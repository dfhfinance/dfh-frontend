...
import { Flex, Box, Text, ExpandableLabel, LinkExternal, Grid, HelpIcon, useTooltip } from '@dfh-finance/uikit'
...
const RoiCalculatorFooter: React.FC<RoiCalculatorFooterProps> = ({
  ...
  const {
    ...
    <>
      <Text>
        {t(
          'The Multiplier represents the proportion of DFH rewards each farm receives, as a proportion of the DFH produced each block.',
        )}
      </Text>
      <Text my="24px">
