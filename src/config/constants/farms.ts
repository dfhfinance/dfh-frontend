...
// TODO---THANHNV: config list pool ở đây
// Chú ý: Nên có 3 pool như bên pancake để đảm bảo việc lấy giá token
// Những pool nào mà add ngoài 2 token BNB hoặc BUSD thì sẽ phải add thêm pool trung gian với 2 base token (BUSD, WBNB)
// Ví dụ add pool CHESS-USDC thì phải add thêm pool USDC-BUSD
const farms: SerializedFarmConfig[] = [
   ...
   */
  {
    ...
    lpSymbol: 'DFH',
    lpAddresses: {
      97: '0x230e23f0744fE767aa628Fcbb6F079087DF23C1C',
  ...
  },
  {
    ...
    lpSymbol: 'DFH-BNB LP',
    lpAddresses: {
      97: '0x73936d5F1EA5dC0bc1a0143b8d987f83A6cacC04',
      56: '0xDAC965EcF6f44C95e1934Ce311438C3eFF2a17e6',
    },
    token: serializedTokens.dfh,
    quoteToken: serializedTokens.wbnb,
  },
  {
    pid: 2,
  ...
  {
    pid: 3,
    lpSymbol: 'DFH-BUSD LP',
    lpAddresses: {
      97: '0x7523a726fb04558eae60027ffce1f25fddc39cf5',
